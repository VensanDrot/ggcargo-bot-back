...
from config.core.choices import EMU_SERVICE_CHOICE, TO_RECEIVER
...
class OrderEMU(BaseModel):
    ...
    service = models.IntegerField(choices=EMU_SERVICE_CHOICE, default=TO_RECEIVER, null=True, blank=True)
